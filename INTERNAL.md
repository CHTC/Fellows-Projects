...
3. Setup new year specific repository (Note: Can be done from submodule or clone of specific repository)
   1. Copy over files/structure in **template/** main repository to new repository
      Note: Best to do `cp -r template/ <submodule root>` as there are hidden files
